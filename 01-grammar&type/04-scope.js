...
function constTest() {
  ...
  /** Hoisting  key js key words get hoisted functions as well. it will grab the entil value of functions.*/
  ...
  var a= 'this is not hoisted'; // var will be undefined. let will give an error message.
